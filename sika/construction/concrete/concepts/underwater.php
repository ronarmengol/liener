...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      ...
      <div class="title">
        <h2>SIKA UNDERWATER CONCRETE</h2>
      </div>
      ...
      <div class="cards">
        <a class="card" href="underwater/concrete-improver.php">Concrete Cohesion Improver</a>
        <a class="card" href="underwater/underwater-improver.php">Underwater Concrete Cohesion Improver</a>
        <a class="card" href="underwater/water-reducer.php">High Range Water Reducer</a>
      </div>
