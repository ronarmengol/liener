...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      ...
      <div class="title">
        <h2>SIKA FIBER REINFORCED CONCRETE</h2>
      </div>
      ...
      <div class="cards">
        <a class="card" href="fiber-reinforced/micro.php">Micro Polypropylene Fiber</a>
        <a class="card" href="fiber-reinforced/macro.php">Macro Structural Synthetic Polypropylene Fiber</a>
      </div>
