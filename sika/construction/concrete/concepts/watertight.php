...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      ...
      <div class="title">
        <h2>SIKA WATERTIGHT CONCRETE</h2>
      </div>
      ...
      <div class="cards">
        <a class="card" href="watertight/crystallizing.php">Crystallizing - Pore blocker</a>
        <a class="card" href="watertight/liquid-pore.php">Liquid Pore Blocking Admixture</a>
        <a class="card" href="watertight/silica.php">Densified / Undensified Silica Fume</a>
        <a class="card" href="watertight/water-reducer.php">Water Reducer</a>
      </div>
