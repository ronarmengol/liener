...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      <a href="../viscosity-admixtures.php">Viscosity Modifying Admixtures</a>
      <div class="title">
        <h2>CONCRETE COHESION IMPROVER</h2>
      </div>
      ...
      <div class="cards">
        <a class="card" href="#">
          <div class="description">
            <h4>SikaFume&#174-930</h4>
            <p>Concrete Additive based on Silica Fume Technology</p>
          </div>
        </a>

        <a class="card" href="#">
          <div class="description">
            <h4>Sika&#174 Stabilizer-40</h4>
            <p>Concrete Cohesion Promoter</p>
          </div>
        </a>
