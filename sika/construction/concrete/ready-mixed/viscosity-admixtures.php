...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      ...
      <div class="title">
        <h2>VISCOSITY MODIFYING ADMIXTURES</h2>
      </div>

      

      <div class="cards">
        <a class="card" href="viscosity-admixtures/cohesion-improver.php">
          Concrete Cohesion Improver
        </a>
        <a class="card" href="viscosity-admixtures/underwater-improver.php">
          Underwater Concrete Cohesion Improver
        </a>
