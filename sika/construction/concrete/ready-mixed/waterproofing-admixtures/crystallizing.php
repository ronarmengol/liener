...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      <a href="../waterproofing-admixtures.php">Sika waterproofing admixtures</a>
      <div class="title">
        <h2>CRYSTALLIZING - PORE BLOCKER</h2>
      </div>
      ...
      <div class="cards">
        <a class="card" href="#">
          <div class="description">
            <h4>Sika&#174 WT-200 P</h4>
            <p>Water Resisting and Crystalling Waterproofing Concrete Admixture</p>
          </div>
        </a>
