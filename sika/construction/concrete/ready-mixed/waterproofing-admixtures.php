...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      ...
      <div class="title">
        <h2>SIKA WATERPROOFING ADMIXTURES</h2>
      </div>

      

      <div class="cards">
        <a class="card" href="waterproofing-admixtures/crystallizing.php">
          Crystallizing - Pore blocker
        </a>
        <a class="card" href="waterproofing-admixtures/liquid.php">
          Liquid Pore Blocking admixture
        </a>
