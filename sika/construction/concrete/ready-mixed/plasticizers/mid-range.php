...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      ...
      <div class="title">
        <h2>MID RANGE WATER REDUCERS</h2>
      </div>
      ...
      <div class="cards">
        <a class="card" href="#">
          <div class="description">
            <h4>SikaPlast&#174-410</h4>
            <p>Water reducing admixture for concrete</p>
          </div>
        </a>
        <a class="card" href="#">
          <div class="description">
            <h4>SikaPlast&#174 V210</h4>
            <p>Powered by ViscoCrete&#174 Mid-range water reducing admixture</p>
          </div>
        </a>
        <a class="card" href="#">
          <div class="description">
            <h4>SikaPlast&#174 V220</h4>
            <p>Powered by ViscoCrete&#174 Mid-range water reducing admixture</p>
          </div>
        </a>
        <a class="card" href="#">
          <div class="description">
            <h4>SikaPlast&#174-440</h4>
            <p>Workability enhancing, plasticizing admixture</p>
          </div>
        </a>
