...
$page_title = 'Liener investments - sika - construction - concrete - ready mixed site batched concrete - sika water reducers / plasticizers - water reducer';
...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      <a href="../plasticizers.php">Sika water reducers / plasticizers</a>
      <div class="title">
        <h2>HIGH RANGE WATER REDUCERS</h2>
      </div>
      ...
      <div class="cards">
        <a class="card" href="#">
          <div class="description">
            <h4>Sika ViscoFlow&#174-44</h4>
            <p>Workability enhancing admixture</p>
          </div>
        </a>
        <a class="card" href="#">
          <div class="description">
            <h4>Sika&#174 ViscoCrete&#174-10</h4>
            <p>High Range Water Reducer Retarder</p>
          </div>
        </a>
        <a class="card" href="#">
          <div class="description">
            <h4>Sika ViscoFlow&#17-25 ZA</h4>
            <p>Workability Enhancing admixture</p>
          </div>
        </a>
        <a class="card" href="#">
          <div class="description">
            <h4>Sika&#174 ViscoCrete&#174-3088+</h4>
            <p>High range wtaer reducing admixture</p>
          </div>
        </a>
