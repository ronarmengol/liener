...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      ...
      <div class="title">
        <h2>HIGH RANGE WATER REDUCERS(POWDER)</h2>
      </div>
      ...
      <div class="cards">
        <a class="card" href="#">
          <div class="description">
            <h4>Sika&#174 ViscoCrete&#174-150</h4>
            <p>High-Performance Superplasticizer / HRWR</p>
          </div>
        </a>
        <a class="card" href="#">
          <div class="description">
            <h4>Sikament&#174 NN Powder</h4>
            <p>Water-Reducing Concrete Admixture</p>
          </div>
        </a>
