...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      ...
      <div class="title">
        <h2>EXTENDED WORKABILITY / WATER REDUCERS</h2>
      </div>
      ...
      <div class="cards">
        <a class="card" href="#">
          <div class="description">
            <h4>Sika ViscoFlow&#174-80</h4>
            <p>Workability enhancing admixture</p>
          </div>
        </a>
        <a class="card" href="#">
          <div class="description">
            <h4>Sika ViscoFlow&#174-77</h4>
            <p>Workability enhancing admixture</p>
          </div>
        </a>
        <a class="card" href="#">
        ...
        <a class="card" href="#">
          <div class="description">
            <h4>SikaPlast&#174 Stallion-2</h4>
            <p>Powered by ViscoCrete&#174 Super-plasticizer with extended workability</p>
          </div>
        </a>
