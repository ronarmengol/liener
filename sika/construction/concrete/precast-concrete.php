...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      ...
      <div class="cards">
        <a class="card" href="precast/wet.php">Wet Precast</a>
        <a class="card" href="precast/semi-dry.php">Semi-dry Concrete / No-slump Concrete</a>
        <a class="card" href="precast/fibers.php">Sika Concrete Fibers</a>
        <a class="card" href="precast/release-agents.php">Sika Concrete Release Agents</a>
