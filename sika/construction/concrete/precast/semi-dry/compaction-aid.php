...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      <a href="../semi-dry.php">Semi-dry concrete / no-slump concrete</a>
      <div class="title">
        <h2>COMPACTION AID</h2>
      </div>
      ...
      <div class="cards">
        ...
        <a class="card" href="#">
          <div class="description">
            <h4>SikaPaver&#174 HC-2 ZA</h4>
            <p>High performance compaction aid for semi-dry / no-slump concrete products</p>
          </div>
        </a>
        <a class="card" href="#">
          <div class="description">
            <h4>SikaPaver&#174 HC-1</h4>
            <p>High performance compaction aid for semi-dry / no-slump concrete products</p>
          </div>
        </a>
        <a class="card" href="#">
          <div class="description">
            <h4>SikaPaver&#174 EC-1</h4>
            <p>High performance compaction aid for semi-dry / extruded concrete</p>
          </div>
        </a>
      </div>
