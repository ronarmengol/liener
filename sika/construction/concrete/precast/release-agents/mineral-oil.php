...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      <a href="../release-agents.php">Sika concrete release agents</a>
      <div class="title">
        <h2>MINERAL OIL BASED FORMWORK RELEASE AGENT</h2>
      </div>
      ...
      <div class="cards">
        <a class="card" href="#">
          <div class="description">
            <h4>Sika&#174 Separol GU ZA</h4>
            <p>Oil based shutter release agent</p>
          </div>
        </a>
      </div>
