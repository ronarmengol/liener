...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      ...
      <div class="title">
        <h2>SIKA CONCRETE FIBERS</h2>
      </div>

      

      <div class="cards">
        <a class="card" href="fibers/micro.php">Micro Polypropylene Fiber</a>
        <a class="card" href="fibers/macro.php">Macro Structural Synthetic Polypropylene Fiber</a>
