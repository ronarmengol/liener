...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      ...
      <div class="title">
        <h2>SET & STRENGTH ACCELERATORS</h2>
      </div>
      ...
      <div class="cards">
        <a class="card" href="#">
          <div class="description">
            <h4>SikaRapid&#174-2</h4>
            <p>Setting accelerator for concrete and mortars</p>
          </div>
        </a>

        <a class="card" href="#">
          <div class="description">
            <h4>SikaRapid&#174 CC</h4>
            <p>Set accelerating admixture</p>
          </div>
        </a>
