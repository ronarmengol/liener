...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      <a href="../precast-concrete.php">Precast-concrete</a>
      <div class="title">
        <h2>SIKA CONCRETE RELEASE AGENTS</h2>
      </div>

      

      <div class="cards">
        <a class="card" href="release-agents/emulsion.php">Emulsion Based Formwork Release Agent</a>
        <a class="card" href="release-agents/mineral-oil.php">Mineral Oil Based Formwork Release Agent</a>
