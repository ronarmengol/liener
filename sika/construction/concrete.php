  ...
  <main>
    ...
    <section class="sika__content">
      ...
      <div class="cards">
        ...
        <a class="card" href="#">Precast Concrete</a>
        <a class="card" href="#">Concrete Concepts</a>
        <a class="card" href="#">Cement Additives</a>
        <a class="card" href="#">Gypsum</a>
        <a class="card" href="#">Durability / Curing</a>
        <a class="card" href="#">Powder Superplasticizers</a>
        <a class="card" href="#">Long Concrete Workability Retention</a>
      </div>
