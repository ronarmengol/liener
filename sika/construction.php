...
<head>
    ...
    <!-- SEO -->
    <title>Liener || Sika - Construction</title>
...
<div>
  ...
  <main>
    ...
    <section class="sika__content">
      ...
      <div class="cards">
        <a class="card" href="construction/concrete.php">Concrete</a>
        <a class="card" href="#">Concrete Repair and Protection</a>
        <a class="card" href="#">Adhesives & sealants</a>
        <a class="card" href="#">Roofing</a>
        <a class="card" href="#">Waterproofing</a>
        <a class="card" href="#">Flooring</a>
      </div>
